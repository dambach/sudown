...
# This will automatically install the {remotes} package and {sudown}
# Change this to FALSE if you'd like to install them manually on your own.
params:
  'Install needed packages for {sudown}': True
  
# Remove the hashtag to specify which version of output you would like.
# Can only choose one at a time.
output:
  sudown::thesis_pdf: default 
#  sudown::thesis_gitbook: default         
#  sudown::thesis_word: default
#  sudown::thesis_epub: default
...
# This chunk ensures that the sudown package is
# installed and loaded. This sudown package includes
# the template files for the thesis.
if (!require(remotes)) {
  if (params$`Install needed packages for {sudown}`) {
...
if (!require(sudown)) {
  if (params$`Install needed packages for {sudown}`) {
    remotes::install_github("dambach/sudown")
  } else {
    stop(
      paste(
        "You need to run",
